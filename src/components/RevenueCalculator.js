...
const RevenueCalculator = () => {
  ...
  return (
    <div style={{backgroundColor: "#2B0573", padding: "20px", minHeight: "100vh"}}>
      <div className="p-6 max-w-4xl mx-auto bg-white rounded-lg shadow-md" ref={containerRef} style={{backgroundColor: "#FFFFFF", color: "#2B0573"}}>
        ...
        <div className="p-4 rounded-lg mb-6" style={{backgroundColor: "#E8E4FF"}}>
        ...
        <div className="h-64 md:h-80" style={{backgroundColor: "#FFFFFF"}}>
